...
<template>
  <aside id="sidebar" class="fixed top-0 left-0 z-20 flex flex-col flex-shrink-0 w-64 h-full pt-16 font-normal duration-75 transition-width" :class="side.side ? 'hidden' : ''" aria-label="Sidebar">
